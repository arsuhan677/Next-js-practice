...
export default function Footer() {
  return (
    <footer className="bg-[#1a1a1a] text-white shadow-lg mt-[50px] md:mt-[80px] lg:mt-[120px]">
      {/* Main Footer Content */}
      <div className="max-w-[1737px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-14 md:py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-10 lg:gap-12">
          ...
          {/* Brand Section */}
          <div className="lg:col-span-2 flex flex-col items-start space-y-5 pb-6 md:pb-0 border-b md:border-b-0 border-gray-700/50">
            ...
            <div className="flex items-center gap-3 pt-2">
              <Link href="#" className="w-9 h-9 rounded-full bg-gray-800 hover:bg-indigo-600 flex items-center justify-center transition-all duration-300 hover:scale-110">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </Link>
              <Link href="#" className="w-9 h-9 rounded-full bg-gray-800 hover:bg-pink-600 flex items-center justify-center transition-all duration-300 hover:scale-110">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="#" className="w-9 h-9 rounded-full bg-gray-800 hover:bg-blue-500 flex items-center justify-center transition-all duration-300 hover:scale-110">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935  0 0024 4.59z" />
                </svg>
              </Link>
              <Link href="#" className="w-9 h-9 rounded-full bg-gray-800 hover:bg-red-600 flex items-center justify-center transition-all duration-300 hover:scale-110">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-3 grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
            ...
            {/* Company Links */}
            <div>
              <h3 className="text-white font-bold text-sm sm:text-base mb-4 uppercase tracking-wider">Company</h3>
              <ul className="space-y-2.5">
                <li><Link href="#" className="text-xs sm:text-sm text-gray-400 hover:text-white hover:translate-x-1 inline-block transition-all duration-200">About Us</Link></li>
                <li><Link href="#" className="text-xs sm:text-sm text-gray-400 hover:text-white hover:translate-x-1 inline-block transition-all duration-200">Our Shop</Link></li>
                <li><Link href="#" className="text-xs sm:text-sm text-gray-400 hover:text-white hover:translate-x-1 inline-block transition-all duration-200">Blog & News</Link></li>
                <li><Link href="#" className="text-xs sm:text-sm text-gray-400 hover:text-white hover:translate-x-1 inline-block transition-all duration-200">Contact Us</Link></li>
              </ul>
            </div>

            {/* Support Links */}
            <div>
              <h3 className="text-white font-bold text-sm sm:text-base mb-4 uppercase tracking-wider">Support</h3>
              <ul className="space-y-2.5">
        ...
        <div className="max-w-[1737px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-center">
            <p className="text-xs sm:text-sm text-gray-400 text-center sm:text-left">
              © 2025 <span className="text-white font-semibold">Suhan</span>. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
