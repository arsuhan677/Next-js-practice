...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 shadow-lg">
      {/* Top Bar */}
      <div className="top-bar-gradient text-white bg-black text-xs sm:text-sm h-9 sm:h-10 flex items-center justify-between px-3 sm:px-4 md:px-12 lg:px-24 relative overflow-hidden">
        ...
        <div className="hidden sm:block text-center flex-1 relative z-10">
          <p className="font-normal leading-6 tracking-wide">
            ...
            Get <span className="font-bold text-yellow-400">+00801701635619</span> aminur rahma suhan
      ...
      {/* Main Bar */}
      <div className="header-glass bg-white h-14 sm:h-16 md:h-20 lg:h-20 flex items-center justify-between px-3 sm:px-4 md:px-8 lg:px-12 xl:px-24 border-b border-gray-200/50 relative">
        {/* Mobile Logo */}
        ...
        <div className="hidden lg:flex items-center flex-1 justify-start z-20">
          <nav className="flex space-x-6 xl:space-x-10 text-base xl:text-lg font-bold uppercase tracking-tight">
            ...
            <Link href="/about" className="nav-link-animated text-gray-900">Shop</Link>
            <Link href="/about/mission" className="nav-link-animated text-gray-900">Category</Link>
            <Link href="/pages" className="nav-link-animated text-gray-900">Category2</Link>
            <Link href="/blogs" className="nav-link-animated text-gray-900">Blogs</Link>
            <Link href="/posts" className="nav-link-animated text-gray-900">Posts</Link>
          </nav>
        </div>
